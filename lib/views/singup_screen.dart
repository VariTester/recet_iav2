                ...
                20, 100, 20, 0),
                  child: Column(
                    children: <Widget>[
                      ...
                      reusableEmailTextField("Ingrese su correo electrónico", Icons.person_outline,false, _emailTextController),
                      const SizedBox(
                        height: 20,
                      ),
                      reusablePasswordTextField("Ingrese su contraseña", Icons.lock_clock_outlined,true, _passwordTextController),
                      const SizedBox(
                        height: 20,
                      ),
                          ...
                          FirebaseAuth.instance.createUserWithEmailAndPassword(
                            ...
                            password: _passwordTextController.text.trim()).then((value){
                              FirebaseFirestore.instance.collection('users').doc(value.user.uid).set({
                                'id':value.user.uid,
                                'name':_userTextController.text.trim(),
                                'phone':_phoneTextController.text,
                                'email':_emailTextController.text.replaceAll(" ", "").toLowerCase(),
