...
class Recipe_details extends StatelessWidget {
  ...
  Recipe_details({Key key, this.thumbnailUrl,this.title,this.rating}) : super(key: key);
        ...
        Padding(
          ...
          child: Center(
            ...
            // SizedBox(height: 10,),
              ...
              child: Text('holaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
